    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "/home/ananta/Desktop/opencv/Attendance-Management-system-using-face-recognition/Attendance(Manually)/"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"/home/ananta/Desktop/opencv/Attendance-Management-system-using-face-recognition/Attendance(Manually)"'
                )
